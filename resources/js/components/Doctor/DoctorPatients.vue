            ...
            <div class="columns is-centered">
                <div class="column is-10-desktop">
                    <div class="box">
                        ...
                        <div class="table-text">DOCTOR PATIENTS LIST</div>
                        ...
                        <b-table
                            ...
                            <b-table-column field="date_admission" label="Date Admission" sortable v-slot="props">
...
<!--                                        </b-dropdown-item>-->
                                        ...
                                        <b-dropdown-item aria-role="listitem" :href="`/doctor-patient-diagnoses/${props.row.patient_diagnose_id}`">
                                            Show diagnoses
                                        </b-dropdown-item>
    ...
    methods: {
        ...
        */
        loadAsyncData() {
            ...
            this.loading = true
            axios.get(`/get-doctor-patients?${params}`)
                .then(({ data }) => {
                    this.data = [];
